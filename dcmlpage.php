...
<div id="UGMGallery_<?php echo $UGML_Id;?>" style="display:none">
	...
	if($TotalImages) {		
		foreach($filtered as $filter) {
			...
			?>
				<?php if($type == "image") { ?>
					<li data-url="<?php echo $image_url; ?>" data-width="900" data-height="550" <?php if($extra_button_url != "") {?> data-extra-button-url="<?php echo $extra_button_url; ?>" data-extra-button-target="<?php echo $UGML_openLink; ?>" <?php } ?> >
						<img src="<?php echo $thumb_image; ?>" alt="<?php echo $image_title ?>"/>
						<div data-thumbnail-content1="">
							<div class="centerDark"><?php echo $image_title ?></div>
						</div>
						<div data-lightbox-desc="">
							<p class="gallery1DecHeader"><?php echo $image_title; ?></p>
